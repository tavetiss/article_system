...
\begin{align}
	-F_{pis} & = F_{bo}\\
	-F_{pis} & = -\frac{K\ {x_0}^2}{L^2}\biggl(\frac{x_m^2}{{x_0}^2} -1\biggr)x_m - \biggl( \frac{K_{HV}\theta}{a} \biggr) - F_f\ \text{sign}(\dot{x}_m)
