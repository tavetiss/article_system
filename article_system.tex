...
%/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\/!\%
	...
	%///////////////////////////////////////////// 
	\subsection{HV hydraulic targeted behavior}	
...
\begin{equation}
	r_{Cf} = \dfrac{\text{Closed HV}}{\text{Opened HV}}	= \dfrac{Cf_c}{Cf_0}	
	\label{eq:r_Cf_definition}
\end{equation}
Where $Cf_f=Cf(\pm x_0)$. The literature does not provide the constitutive relation between $x_m$ and $Cf$ for a buckled flexible tube. Therefore, we preliminarily assume that it is linear and defined as follows :
\begin{align}
	Cf(x_m) & = Cf_0 + \dfrac{Cf_f - Cf_0}{x_0}\ x_m  \notag \\
