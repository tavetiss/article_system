...
The ratio $r_{Cf}$ has been increased until it was sufficient to prioritize the flow through the opened HV. The mastication cycle is identically quadrupled in order to test the system cycling robustness. Also, the earplug is assumed as a perfect flow rate source.
