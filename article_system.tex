...
Stiffness of the guide blade along $\vec{z}$  & $K_{gb}$   & 190 [N/m] \\
...
\end{equation}
$I_{gb}$ is the second moment of area along $\vec{y}$ axis. According the material properties and GB dimensions (tab. \ref{tab:parametres_lames}) $K_{gb} = 4.0e2$, which is negligible before $K=0.2e6$.

$K_{bb}$ is for its part verified through a FEM generated with the BO CAD on ANSYS Workbench.
